...
test_surface = pygame.image.load('nền1.PNG').convert()

font = pygame.font.Font('game.ttf', 28)  # Chọn font và kích thước
...
notification_image = pygame.image.load('space.jpg').convert()
